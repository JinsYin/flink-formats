...
public class OggJsonFormatFactoryTest extends TestLogger {
    ...
    public void testSeDeSchema() {
        final OggJsonDeserializationSchema expectedDeser = new OggJsonDeserializationSchema(
                ROW_TYPE,
        ...
        thrown.expect(containsCause(new UnsupportedOperationException(
                "Ogg format doesn't support as a sink format yet.")));
    ...
    private static DynamicTableSource createTableSource(Map<String, String> options) {
        return FactoryUtil.createTableSource(
                ...
                new Configuration(),
                OggJsonFormatFactoryTest.class.getClassLoader());
    }
